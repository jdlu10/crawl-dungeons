  ...
  return (
    <button
      ...
      className={`
        ...
        } inline-flex items-center bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 overflow-hidden min-w-14 min-h-14 rounded-full justify-center
